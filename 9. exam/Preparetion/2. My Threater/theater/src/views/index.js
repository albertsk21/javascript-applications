...
const indexTemplate = (events) => html`
        <section class="welcomePage">
            ...
            <div id="events">
                ...
                <div class="theaters-container">
                    ...
                    ${events.length > 0 ? events.map(event => eventTemplate(event)) : html` <h4 class="no-event">No Events Yet...</h4>` }
...
export async function indexPage(ctx){
    ...
    ctx.render(indexTemplate(events));
